                                ...
                                <div className='row g-3 mt-1'>
                                    {specimenList.map((specimen, index) => (
                                        <div className='col-md-3' key={index}>
                                            <div className={`d-flex align-items-center p-3 rounded shadow-sm border fs-6 ${(requestData.data.specimen || []).some(item => item.name === specimen) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                <input type='checkbox' className='form-check-input border border-dark me-3' value={specimen} checked={(requestData.data.specimen || []).some(item => item.name === specimen)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                        ...
                        <div className='row m-1'>
                            ...
                            <div className='col-6'>
                                <div className='card pt-2 pb-2 ps-3 shadow-sm'>
                                    ...
                                    <span className='fs-5 fw-semibold'>{requestData.data.sex || '-'}</span>
                                </div>
                            </div>
                        </div>
                    ) : (
                                ...
                                <div className='row mt-3'>
                                    <div className='col-6'>
                                        <div className='card pt-2 pb-1 ps-3 mb-3 shadow-sm'>
                                            ...
                                            <span className='fs-5 fw-semibold'>{requestData.data.wholeAnimal.map(animal => animal.name).join(', ')}</span>
                                        </div>
                                    </div>
                                </div>
                                <div className='row g-3'>
                                    {specimenPart.map((specimen, index) => (
                                        <div className='col-md-3' key={index}>
                                            <div className={`d-flex align-items-center p-3 rounded shadow-sm border fs-6 ${(requestData.data.specimenPart || []).some(item => item.name === specimen) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                <input type='checkbox' className='form-check-input border border-dark me-3' value={specimen} checked={(requestData.data.specimenPart || []).some(item => item.name === specimen)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                                                <label className='form-check-label m-0' style={{ opacity: 1, pointerEvents: 'none' }}>{specimen}</label>
                                            </div>
                                        </div>
                                    ))}
                        ...
                        <div className='p-3'>
                            ...
                            <div className='row g-3 mt-1  '>
                                {pathologyList.map((pathology, index) => (
                                    <div className='col-md-auto' key={index}>
                                        <div className={`d-flex align-items-center p-3 rounded shadow-sm border fs-6 ${(requestData.data.pathologyList).includes(pathology) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                            <input type='checkbox' className='form-check-input border border-dark me-3' value={pathology} checked={(requestData.data.pathologyList).includes(pathology)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                                ...
                                <div className='col-7'>
                                    ...
                                    <div className='row g-1 gap-2 mt-2'>
                                        {isoAndIdenList.map((isoAndIdenList, index) => (
                                            <div key={index}>
                                                <div className={`d-flex align-items-center p-2 rounded shadow-sm border  ${(requestData.data.isoAndIdenList).includes(isoAndIdenList) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                    <input type='checkbox' className='form-check-input border border-dark me-3' value={isoAndIdenList} checked={(requestData.data.isoAndIdenList).includes(isoAndIdenList)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                                    ...
                                    <div className='row g-1 gap-2 mt-2'>
                                        {rapidPlateTest.map((rapidPlateTest, index) => (
                                            <div className='col-5' key={index}>
                                                <div className={`d-flex align-items-center p-2 rounded shadow-sm border  ${(requestData.data.rapidPlateTest).includes(rapidPlateTest) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                    <input type='checkbox' className='form-check-input border border-dark me-3' value={rapidPlateTest} checked={(requestData.data.rapidPlateTest).includes(rapidPlateTest)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                                ...
                                <div className='col-4'>
                                    ...
                                    <div className='row g-1 gap-2 mt-2'>
                                        {fecalysisList.map((fecalysis, index) => (
                                            <div key={index}>
                                                <div className={`d-flex align-items-center p-2 rounded shadow-sm border  ${(requestData.data.fecalysis).includes(fecalysis) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                    <input type='checkbox' className='form-check-input border border-dark me-3' value={fecalysis} checked={(requestData.data.fecalysis).includes(fecalysis)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                                    ...
                                    <div className='row g-1 gap-2 mt-2'>
                                        {parasiteIden.map((parasite, index) => (
                                            <div className='col-auto' key={index}>
                                                <div className={`d-flex align-items-center p-2 rounded shadow-sm border  ${(requestData.data.parasiteIden).includes(parasite) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                    <input type='checkbox' className='form-check-input border border-dark me-3' value={parasite} checked={(requestData.data.parasiteIden).includes(parasite)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                                    ...
                                    <div className='row g-1 gap-2 mt-2'>
                                        {bloodParasiteExam.map((bloodParasiteExam, index) => (
                                            <div className='col-12' key={index}>
                                                <div className={`d-flex align-items-center p-2 rounded shadow-sm border  ${(requestData.data.bloodParasiteExam).includes(bloodParasiteExam) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                    <input type='checkbox' className='form-check-input border border-dark me-3' value={bloodParasiteExam} checked={(requestData.data.bloodParasiteExam).includes(bloodParasiteExam)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                            ...
                            <div className='row g-3 mt-1 gap-2'>
                                {virologyList.map((virology, index) => (
                                    <div className='col-md-5' key={index}>
                                        <div className={`d-flex align-items-center p-3 rounded shadow-sm border  fs-6 ${(requestData.data.virologyList).includes(virology) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                            <input type='checkbox' className='form-check-input border border-dark me-3' value={virology} checked={(requestData.data.virologyList).includes(virology)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                            ...
                            <div className='col-auto mt-3 mb-3'>
                                ...
                                <div className='row g-3 gap-1 mt-1'>
                                    {elisaList.map((elisa, index) => (
                                        <div className='col-5' key={index}>
                                            <div className={`d-flex align-items-center p-3 rounded shadow-sm border  fs-6 ${(requestData.data.elisaList).includes(elisa) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                <input type='checkbox' className='form-check-input border border-dark me-3' value={elisa} checked={(requestData.data.elisaList).includes(elisa)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                            ...
                            <div className='row g-3 mt-1 gap-2'>
                                {pcrList.map((pcr, index) => (
                                    <div className='col-md-5' key={index}>
                                        <div className={`d-flex align-items-center p-3 rounded shadow-sm border  fs-6 ${(requestData.data.pcrList).includes(pcr) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                            <input type='checkbox' className='form-check-input border border-dark me-3' value={pcr} checked={(requestData.data.pcrList).includes(pcr)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                            ...
                            <div className='col-auto'>
                                <div className='row g-3 mt-1 gap-1'>
                                    {purposeList.map((purpose, index) => (
                                        <div className='col-5' key={index}>
                                            <div className={`d-flex align-items-center p-3 rounded shadow-sm border  fs-6 ${(requestData.data.purposeList).includes(purpose) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                <input type='checkbox' className='form-check-input border border-dark me-3' value={purpose} checked={(requestData.data.purposeList).includes(purpose)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                                        ...
                                        <div className='row g-3 mt-1 ms-3'>
                                            {quantityOfSample.map((quantityOfSample, index) => (
                                                <div className='col-md-4' key={index}>
                                                    <div className={`d-flex align-items-center p-2 rounded shadow-sm border ${(requestData.data.quantityOfSample).includes(quantityOfSample) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                        <input type='checkbox' className='form-check-input border border-dark me-3' value={quantityOfSample} checked={(requestData.data.quantityOfSample).includes(quantityOfSample)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
                                        ...
                                        <div className='row g-3 mt-1 ms-3'>
                                            {preservationUsed.map((preservationUsed, index) => (
                                                <div className='col-md-7' key={index}>
                                                    <div className={`d-flex align-items-center p-2 rounded shadow-sm border ${(requestData.data.preservationUsed).includes(preservationUsed) ? 'border-primary bg-primary bg-opacity-10' : ''}`}>
                                                        <input type='checkbox' className='form-check-input border border-dark me-3' value={preservationUsed} checked={(requestData.data.preservationUsed).includes(preservationUsed)} disabled style={{ opacity: 1, pointerEvents: 'none' }} />
