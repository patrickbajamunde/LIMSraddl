...
import Page2 from './ArfGenSample/Page2';
import Page3 from './ArfGenSample/Page3';
                    ...
                    <View style={[styles.table, { marginTop: 20 }]}>
                        ...
                        <View style={[styles.row, styles.cellTwo, { width: '100%', borderLeftWidth: 0, borderRightWidth: 0 }]}>
                            <View style={[{ width: '55%', paddingLeft: 4 }]}>
                                ...
                                <Text style={[styles.normalFont, { fontSize: 9 }]}>Owner/Farm: {request.locOfFarm}</Text>
                            ...
                            <View style={[styles.cellTwo, { width: '45%', borderBottomWidth: 0, paddingLeft: 4 }]}>
                                <Text style={[styles.boldFont, { fontSize: 9 }]}>SUBMITTED BY:</Text>
                                <Text style={[styles.normalFont, { fontSize: 9 }]}>Name: {request.clientName}</Text>
                                <Text style={[styles.normalFont, { fontSize: 9 }]}>Address: {request.clientAddress}</Text>
                                <Text style={[styles.normalFont, { fontSize: 9 }]}>Age: {request.clientAge}</Text>
                                <Text style={[styles.normalFont, { fontSize: 9 }]}>Sex: {request.clientSex}</Text>
                                <Text style={[styles.normalFont, { fontSize: 9 }]}>Contact No.: {request.clientContact}</Text>
                                <Text style={[styles.normalFont, { fontSize: 9 }]}>Email: {request.clientEmail}</Text>
                            </View>
                        </View>
                        ...
                        <View style={[styles.row, styles.cellTwo, { width: '100%', borderLeftWidth: 0 }]}>
                            ...
                            <View style={[styles.row, { flexWrap: 'wrap', width: '86%', borderBottomWidth: 0, paddingBottom: 6 }]}>
                                {specimenList.map((specimen, index) => (
                                    <View key={index} style={[styles.row, { width: '25%', alignItems: 'center', paddingLeft: 18 }]}>
                                        <Text style={isChecked(specimen, request.specimen)}>
                                        </Text>
                            ...
                            <View style={[styles.cellTwo, styles.row, { width: '45%', borderBottomWidth: 0, borderRightWidth: 0 }]}>
                                ...
                                {sexList.map((sex, index) => (
                                    <View key={index} style={[styles.row, { alignItems: 'center', paddingLeft: 18, }]}>
                                        <Text style={isChecked(sex, request.sex)}></Text>
                        ...
                        <View style={[styles.row, styles.cellTwo, { width: '100%', borderLeftWidth: 0 }]}>
                            ...
                            <View style={[styles.row, { flexWrap: 'wrap', width: '86%', borderBottomWidth: 0 }]}>
                                <View style={[styles.row, { width: '100%', borderBottomWidth: 1 }]}>
                                    ...
                                    <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                        <Text style={[isChecked(wholeAnimal[0], request.wholeAnimal)]}></Text>
                                        <Text style={styles.row}>{wholeAnimal[0]}</Text>
                                    </View>
                                    <View style={[styles.row, { alignItems: 'center', paddingLeft: 112 }]}>
                                        <Text style={[isChecked(wholeAnimal[1], request.wholeAnimal)]}></Text>
                                        <Text style={styles.row}>{wholeAnimal[1]}</Text>
                                    </View>
                                </View>
                                {specimenPart.map((specimen, index) => (
                                    <View key={index} style={[styles.row, { width: '25%', alignItems: 'center', paddingLeft: 18 }]}>
                                        <Text style={isChecked(specimen, request.specimenPart)}>
                                        </Text>
                                        <Text style={styles.row}>{specimen}</Text>
                                    </View>
                                ))}
                        ...
                        <View style={styles.row}>
                            <View style={[styles.cellTwo, { width: "48%", borderLeftWidth: 0, textAlign: 'center', borderRightWidth: 0 }]}>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(pathologyList[0], request.pathologyList)}></Text>
                                    <Text style={styles.row}>{pathologyList[0]}</Text>
                                </View>
                            </View>
                            <View style={[styles.cellTwo, { width: "52%", borderLeftWidth: 0 }]}>
                                <View style={[styles.row]}>
                                    <Text style={[isChecked(pathologyList[1], request.pathologyList), { marginTop: 3 }]}></Text>
                                    <Text style={[styles.row, { flexWrap: 'wrap', width: '85%' }]}>{pathologyList[1]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center' }]}>
                                    <Text style={isChecked(pathologyList[2], request.pathologyList)}></Text>
                        ...
                        <View style={[styles.row, styles.cellTwo, { width: '100%', borderLeftWidth: 0 }]}>
                            <View style={[{ width: '55%' }]}>
                                ...
                                <View style={[styles.row, { paddingLeft: 18 }]}>
                                    <Text style={[isChecked(isoAndIdenList[0], request.isoAndIdenList), { marginTop: 3 }]} />
                                    <Text style={[styles.row, { flexWrap: 'wrap', width: '85%' }]}>{isoAndIdenList[0]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(isoAndIdenList[1], request.isoAndIdenList)}></Text>
                                    <Text style={styles.row}>{isoAndIdenList[1]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(isoAndIdenList[2], request.isoAndIdenList)}></Text>
                                ...
                                <View style={[styles.row, { width: '86%', flexWrap: 'wrap', paddingLeft: 18 }]}>
                                    {rapidPlateTest.map((test, index) => (
                                        <View key={index} style={[styles.row, { alignItems: 'center', width: '50%' }]}>
                                            <Text style={isChecked(test, request.rapidPlateTest)} />
                                            <Text>{test}</Text>
                                        </View>
                                    ))}
                                </View>
                        ...
                        <View style={styles.row}>
                            <View style={[styles.cellTwo, { width: "100%", borderLeftWidth: 0, paddingLeft: 4, paddingTop: 2, paddingBottom: 8 }]}>
                                <Text style={{ fontSize: 9 }}>Other Tests: ________</Text>
                            </View>
                        </View>
                        <View style={styles.row}>
                            <View style={[styles.cellTwo, styles.row, { width: "100%", borderLeftWidth: 0, paddingLeft: 18 }]}>
                                <View style={[styles.row, { alignItems: 'center' }]}>
                                    ...
                                    <Text style={styles.normalFont}>Water Coliforn Count</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 198 }]}>
                                    <Text style={styles.checkbox} />
                                    <Text style={styles.normalFont}>Others</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.row, styles.cellTwo, { width: '100%', borderLeftWidth: 0 }]}>
                            <View style={[{ width: '55%' }]}>
                                <View style={styles.row}>
                                    <View style={[{ width: '50%' }]}>
                                        ...
                                        {fecalysisList.map((fecalysis, index) => (
                                            <View key={index} style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                                <Text style={isChecked(fecalysis, request.fecalysis)} />
                                                <Text>{fecalysis}</Text>
                                            </View>
                                        ))}
                                    </View>
                                    <View style={[styles.cellTwo, { width: '50%', borderBottomWidth: 0, borderRightWidth: 0 }]}>
                                        ...
                                        {parasiteIden.map((parasite, index) => (
                                            <View key={index} style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                                <Text style={isChecked(parasite, request.parasiteIden)} />
                                                <Text>{parasite}</Text>
                                            </View>
                                        ))}
                                ...
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18, borderTopWidth: 1 }]}>
                                    <Text style={styles.checkbox} />
                                    <Text style={styles.normalFont}>Others</Text>
                                </View>
                            </View>
                                ...
                                <View style={[{ width: '86%', paddingLeft: 18 }]}>
                                    {bloodParasiteExam.map((exam, index) => (
                                        <View key={index} style={[styles.row, { alignItems: 'center' }]}>
                                            <Text style={isChecked(exam, request.bloodParasiteExam)} />
                                            <Text>{exam}</Text>
                                        </View>
                                    ))}
                                </View>
                        ...
                        <View style={styles.column}>
                            <View style={[styles.cellTwo, styles.row, { width: "100%", borderLeftWidth: 0, paddingLeft: 8 }]}>
                                <View style={[styles.row, { alignItems: 'center' }]}>
                                    <Text style={isChecked(virologyList[0], request.virologyList)} />
                                    <Text style={styles.normalFont}>{virologyList[0]}</Text>
                                </View>
                            </View>
                            <View style={[styles.cellTwo, { width: "100%", borderLeftWidth: 0, paddingLeft: 18 }]}>
                                <View style={[styles.row, { alignItems: 'center' }]}>
                                    <Text style={isChecked(virologyList[1], request.virologyList)} />
                                    <Text style={styles.normalFont}>{virologyList[1]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center' }]}>
                                    <Text style={isChecked(virologyList[2], request.virologyList)} />
                                    <Text style={styles.normalFont}>{virologyList[2]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center' }]}>
                                    <Text style={isChecked(virologyList[3], request.virologyList)} />
                        ...
                        <View style={[styles.row, styles.cellTwo, { width: '100%', borderLeftWidth: 0 }]}>
                            <View style={[{ width: '62%' }]}>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[0], request.elisaList)} />
                                    <Text>{elisaList[0]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[2], request.elisaList)} />
                                    <Text>{elisaList[2]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[4], request.elisaList)} />
                                    <Text>{elisaList[4]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[6], request.elisaList)} />
                                    <Text>{elisaList[6]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[8], request.elisaList)} />
                                    <Text>{elisaList[8]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[10], request.elisaList)} />
                                    <Text>{elisaList[10]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[12], request.elisaList)} />
                                    <Text>{elisaList[12]}</Text>
                                </View>
                            </View>
                            <View style={[styles.cellTwo, { width: '38%', borderBottomWidth: 0, borderRightWidth: 0 }]}>
                                <View style={[styles.row, { paddingLeft: 18 }]}>
                                    <Text style={[isChecked(elisaList[1], request.elisaList), { marginTop: 3 }]} />
                                    <Text style={[styles.row, { flexWrap: 'wrap', width: '82%' }]}>{elisaList[1]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[3], request.elisaList)} />
                                    <Text>{elisaList[3]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[5], request.elisaList)} />
                                    <Text>{elisaList[5]}</Text>
                                </View>
                                <View style={[styles.row, { paddingLeft: 18 }]}>
                                    <Text style={[isChecked(elisaList[7], request.elisaList), { marginTop: 3 }]} />
                                    <Text style={[styles.row, { flexWrap: 'wrap', width: '82%' }]}>{elisaList[7]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[9], request.elisaList)} />
                                    <Text>{elisaList[9]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(elisaList[11], request.elisaList)} />
                        ...
                        <View style={[styles.cellTwo, { width: '100%', borderLeftWidth: 0 }]}>
                            {pcrList.map((pcr, index) => (
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(pcr, request.pcrList)} />
                                    <Text>{pcr}</Text>
                                </View>
                            ))}
                        </View>
                        ...
                        <View style={[styles.row, styles.cellTwo, { width: '100%', borderLeftWidth: 0 }]}>
                            <View style={[{ width: '62%' }]}>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(purposeList[0], request.purposeList)} />
                                    <Text>{purposeList[0]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(purposeList[2], request.purposeList)} />
                                    <Text>{purposeList[2]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(purposeList[4], request.purposeList)} />
                                    <Text>{purposeList[4]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(purposeList[6], request.purposeList)} />
                                    <Text>{purposeList[6]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(purposeList[8], request.purposeList)} />
                                    <Text>{purposeList[8]}</Text>
                                </View>
                            </View>
                            <View style={[styles.cellTwo, { width: '38%', borderBottomWidth: 0, borderRightWidth: 0 }]}>
                                <View style={[styles.row, { paddingLeft: 18 }]}>
                                    <Text style={[isChecked(purposeList[1], request.purposeList), { marginTop: 3 }]} />
                                    <Text style={[styles.row, { flexWrap: 'wrap', width: '82%' }]}>{purposeList[1]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(purposeList[3], request.purposeList)} />
                                    <Text>{purposeList[3]}</Text>
                                </View>
                                <View style={[styles.row, { alignItems: 'center', paddingLeft: 18 }]}>
                                    <Text style={isChecked(purposeList[5], request.purposeList)} />
                                    <Text>{purposeList[5]}</Text>
                                </View>
                                <View style={[styles.row, { paddingLeft: 18 }]}>
                                    <Text style={[isChecked(purposeList[7], request.purposeList), { marginTop: 3 }]} />
