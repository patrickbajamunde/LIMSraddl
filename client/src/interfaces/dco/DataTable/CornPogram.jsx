...
export default function CornProgram() {
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="d-flex align-items-center gap-2">
                    ...
                    />
                    <Link to={`/Dco/requestDetails/${row._id}`} state={{ from: '/Dco/CornProgram/' }} type="button" className="btn p-0 border-0"><i className="bi bi-eye"></i></Link>
                </div>
            ),
        },
    ];
